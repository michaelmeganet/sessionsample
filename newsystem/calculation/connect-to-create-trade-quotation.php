...
<div class="modal fade  bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="add_mat">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class='modal-body'>
                <div v-if='validation_stats != "ok"'>
                <?php include_once './material/addmaterial-modal.php'; ?>
                </div>
                <div v-else>
                    <h4>{{validation_resp}}</h4>
                </div>
                
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal" v-if='validation_stats != "ok"'>Cancel</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal" v-else>Close</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
        <div class="tab-pane fade show" v-bind:class="mainactive" id="nav-main" role="tabpanel" aria-labelledby="nav-main-tab" v-bind:style="{backgroundColor:divBackColor}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4 align-items-center align-bottom">
                    <input type="checkbox" class="checkbox" v-model="freepage" disabled/>
                    <label class="custom-label" >Free Page Mode</label>
                    <div class="text-right">
                        <button type='button' class='btn btn-info' data-toggle='modal' data-target='#add_mat' data-backdrop='static' data-keyboard='false'>New Material</button>
                    </div>
                </div>
                <hr/>
            </div>
            ...
            <div class="form-group" v-show='step3show'>
                ...
                <?php include_once("dimension-div.php"); ?>
            ...
            <div class="form-group" v-show='step4show'>
                ...
                <div class="row">
                    <div class='col-md-4'>
                        <label class='control-label'>Process Code   (
                            <span v-if='specialShapeOrder === "TRADE"' Style="color:red">Price must be manually inserted!</span> <!--IF Trade, then tell user to input price manually-->
                            <span v-else-if='ShapeCode !== "PLATEN"' Style="color:red">  No Pmach for this material</span>
                            )</label>
                ...
                <div class="row">
                    <div class='col-md'>
                        ...
                        <form action="" method="post">
                            ...
                            <input type="hidden" name ="specialShapeOrder" id="specialShapeOrder"  v-bind:value="ShapeCode + ' (' + specialShapeOrder + ')'" placeholder="specialShapeOrder" v-if="specialShapeOrder === 'TRADE'"/>
                            <input type="hidden" name ="specialShapeOrder" id="specialShapeOrder"  v-bind:value="specialShapeOrder" placeholder="specialShapeOrder" v-else/>
