	...
	public function getcurrentPeriod(){
		...
		$mon = $this->mon;
                ...
                if ((intval($mon) == 12)) {
                    ...
                    $intYearNext = intval($year) + 1;
                    $year = strval($intYearNext);
                ...
                $intmonNext =  intval($mon) + 1;
                $mon = strval($intmonNext);
		if (strlen($mon) == 1 ) {
...
Class ConvertDate {
    ...
    public function __construct($YYYY_mm_dd){
	...
	public function getDD_MM_YYYY(){// get Year-Month-Day foramt of current date
		$mday = $this->mday;
		$mon  = $this->mon;
		$year = $this->year;
		$formated_date .= $mday. "-";
