...
class MATERIAL_SPECIAL_PRICE_CID extends MATERIAL_PRICE_TABLE {
    ...
    public function __construct($cid, $com, $materialcode,$custype, $dimension_array) {
...
//        $this->thickness = parent::thickness;
        ### 2. check if there is any special price table for this customer of this materailcode
          $objMatPrice = new \PRICE($materialcode, $cid, $custype);
          $materialTable = $objMatPrice->get_matpricetab();
          if ($materialTable == 'empty'){
              throw new Exception("Cannot find Material Table with grade = $materialcode, cid = $cid, custype = $custype");
          }
