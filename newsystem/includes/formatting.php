...
function wpautop($pee, $br = 1) {
	...
	$pee = preg_replace('/\n?(.+?)(?:\n\s*\n|\z)/s', "\n$1\n", $pee); //changes made to comply with the invoide do address list *************************************
...
//begin specially make for mould base quotation
function wpautopPSVPMB($pee, $br = 1) {
	$pee = $pee . "\n"; // just to make things a little easier, pad the end
	$pee = preg_replace('|<br />\s*<br />|', "\n\n", $pee);
	// Space things out a little
	$allblocks = '(?:table|thead|tfoot|caption|colgroup|tbody|tr|td|th|div|dl|dd|dt|ul|ol|li|pre|select|form|blockquote|address|math|style|script|object|input|param|p|h[1-6])';
...
//end specially make for mould base quotation
